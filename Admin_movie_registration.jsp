                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form">
                                   <div class="form-group">
                                        <label class="col-sm-3 control-label">영화관</label>
                                        <div class="col-sm-6">
                                            <select class="rating">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="input1" id="input1" required="" placeholder="영화이름">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">장르</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="input2" id="input2" required="" placeholder="장르">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" required="" name="input4" id="input4" placeholder="감독">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">배우</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" required="" name="input5" id="input5" placeholder="배우">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                           <select class="rating">
                                               <option value="15">전체이용가</option>
                                               <option value="20">15세 이용가</option>
                                               <option value="25">18세 이용가</option>
                                           </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">동영상 URL</label>
                                        <div class="col-sm-6">
                                            <input type="password" class="form-control " name="input7" id="input7" required="" placeholder="동영상 URL">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">사진</label>
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control " required="" name="input9" id="input9" placeholder="사진">
                                        </div>
                                    </div>
