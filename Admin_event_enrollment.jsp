                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form">
                                    ...
                                    <div class="form-group inner">
                                        <label class="col-sm-3 control-label">이벤트 상세제목</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group inner">
                                        ...
                                        <div class="col-sm-6">
                                           <input type="date" class="form-control" name="trip" id="date" value="2018-09-22" min="2018-01-01" max="2018-12-31" required="" id="input3">
                                        </div>
                                    </div>
                                    <div class="form-group inner">
                                        <label class="col-sm-3 control-label">종류일</label>
                                        <div class="col-sm-6">
                                           <input type="date" class="form-control" name="trip" id="date" value="2018-09-29" min="2018-01-01" max="2018-12-31" required="" id="input3">
                                        </div>
                                    </div>
                                    <div class="form-group inner">
                                        <label class="col-sm-3 control-label">이벤트 대표사진</label>
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control text" name="input5" id="input5" placeholder="영화관 주소">
                                        </div>
                                    </div>
                                    <div class="form-group inner">
